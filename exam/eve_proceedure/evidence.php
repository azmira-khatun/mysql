...
<div class="forms-container">
    ...
    <form method="post">
        <h3 style="text-align:center; color:black">Manufacturer Table</h3>
        <table>
            <tr>
    ...
    <!-- Add Product Form -->
    <form method="post">
        <h3 style="text-align:center; color:black"">Product Table</h3>
        <table>
            <tr>
                <td><label>Name</label></td>
    ...
    <form method="post">
        <h3 style="text-align:center; color:black"">Delete Manufacturer</h3>
        <table>
            <tr>
                <td><label>Manufacturer</label></td>
                <td>
